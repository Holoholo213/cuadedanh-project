...
<form action={{ route("post.store") }} method="POST" enctype="multipart/form-data">
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control @error(" description") is-invalid @enderror" id="description" placeholder="Miêu tả" name="description">
        </div>
        ...
        <div class="form-group">
            <textarea class="summernote" placeholder="Nội dung" name="content"></textarea>
        </div>
